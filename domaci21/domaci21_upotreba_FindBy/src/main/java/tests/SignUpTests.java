...
public class SignUpTests extends BaseTests {
    ...
    public void invalidEmail() {
        ...
        getSignUpPage().enterDataToConfirmationPasswordField("Sifra123");
    ...
    public void passwordLessThan5Char() {
        ...
        getSignUpPage().enterDataToConfirmationPasswordField("1234");
        getSignUpPage().clickSignMeUpBtn();
    ...
    public void passwordNotMatching() {
        ...
        getSignUpPage().enterDataToConfirmationPasswordField("ab1234");
        getSignUpPage().clickSignMeUpBtn();
    ...
    public void accountAlreadyExist() throws InterruptedException {
        ...
        getSignUpPage().enterDataToConfirmationPasswordField("12345");
        getSignUpPage().clickSignMeUpBtn();
        Thread.sleep(2000);
