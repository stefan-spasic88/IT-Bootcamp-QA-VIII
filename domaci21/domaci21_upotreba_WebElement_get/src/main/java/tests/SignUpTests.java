...
public class SignUpTests extends BaseTests{
    ...
    public void invalidEmail(){
        ...
        getSignUpPage().enterDataToConfirmationPassField("Sifra123");
    ...
    public void passwordLessThan5Char(){
        ...
        getSignUpPage().enterDataToConfirmationPassField("1234");
        getSignUpPage().clickSignMeUpBtn();
    ...
    public void passwordNotMatching(){
        ...
        getSignUpPage().enterDataToConfirmationPassField("ab1234");
        getSignUpPage().clickSignMeUpBtn();
    ...
    public void accountAlreadyExist() throws InterruptedException {
        ...
        getSignUpPage().enterDataToConfirmationPassField("12345");
        getSignUpPage().clickSignMeUpBtn();
        Thread.sleep(2000);
